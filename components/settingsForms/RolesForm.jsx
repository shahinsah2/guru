  ...
  const { register, handleSubmit, setValue, watch, formState: { errors }, reset } = useForm({
    ...
    defaultValues: data || {
      ...
      module_access: [
        ...
        { module_name: "Product", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        { module_name: "Group", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        ...
        { module_name: "Po_quotation", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        { module_name: "Purchase_order", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        { module_name: "Purchase", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        { module_name: "Supplier", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        ...
        { module_name: "UserPerformance", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
        { module_name: "Supplier", permissions: permissionKeys.reduce((acc, key) => ({ ...acc, [key]: false }), {}) },
      ],
    },
  });
