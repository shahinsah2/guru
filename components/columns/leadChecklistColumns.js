// @/components/columns/leadChecklistColumns.js
...
import { deleteLeadChecklist } from "@/actions/leadChecklistActions"
    ...
    cell: ({ row }) => {
      ...
      const confirmDelete = async () => {
        try {
          ...
          toast.error("Failed to delete lead checklist. Please try again.")
        }
      }
          ...
          {isDeleteConfirmOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
              <div className="bg-white p-6 rounded-md max-w-sm mx-auto">
                ...
                <p className="mt-2 text-sm">Are you sure you want to delete this lead checklist?</p>
