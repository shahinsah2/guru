...
// Define a separate component for the actions cell
const DepartmentActionsCell = ({ row }) => {
...
export const columns = [
  ...
  {
    id: "actions",
    cell: DepartmentActionsCell, // Use the new component here
  },
];

// CreateNewDepartmentButton component
  ...
  return (
    <div className="flex justify-end mb-1">
      <Button
        ...
        onClick={() => router.push("/settings/departments/new")}
      >
