...
const ActionsCell = ({ row }) => {
  ...
  const onEdit = () =>
    router.push(`/settings/service-priority-level/${row.original._id}`);
...
// CreateNewServicePriorityLevelButton component
  ...
  return (
    <div className="flex justify-end mb-1">
      <Button
        ...
        onClick={() => router.push("/settings/service-priority-level/new")}
      >
