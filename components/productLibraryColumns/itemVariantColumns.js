// @/components/productLibraryColumns/itemVariantColumns.js
...
// CreateNewItemVariantButton component with permission check
export const CreateNewItemVariantButton = () => {
  ...
  return (
    <div className="flex justify-end mb-1">
      <Button className="bg-blue-500 text-white" onClick={() => router.push("/product-library/item-variant/new")}>
