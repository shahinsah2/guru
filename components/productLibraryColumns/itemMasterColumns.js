// @/components/productLibraryColumns/itemMasterColumns.js

"use client";

import { MoreHorizontal } from "lucide-react";
import { Button } from "@/components/ui/button";
import { deleteItemMaster } from "@/actions/productLibrary/itemMasterActions";
...
export const CreateNewItemButton = () => {
  ...
  return (
    <div className="flex justify-end mb-1">
      <Button className="bg-blue-500 text-white" onClick={() => router.push("/product-library/item-master/new")}>
        Create New Item
      </Button>
    </div>
  );
