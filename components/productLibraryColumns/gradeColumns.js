// @/components/productLibraryColumns/gradeColumns.js
...
// CreateNewGradeButton component with permission check
export const CreateNewGradeButton = () => {
  ...
  return (
    <div className="flex justify-end mb-1">
      <Button className="bg-blue-500 text-white" onClick={() => router.push("/product-library/grade/new")}>
        Create New Grade
      </Button>
    </div>
  );
